...
#[link(name = "freefare_sys", kind = "dylib")]
extern crate libc;
extern crate nfc_sys;

use libc::{off_t, size_t, ssize_t, int32_t, uint16_t, uint32_t, uint8_t};
...
extern "C" {
    ...
    pub fn freefare_get_tag_uid(tag: FreefareTag) -> *mut ::std::os::raw::c_char;
